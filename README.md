...
Globe Guardians is a 2D educational game developed using Pygame as part of the NASA Space Apps Challenge.

The game transforms environmental learning into an engaging experience where players battle pollution-based bosses by answering quiz questions correctly. It combines gameplay with real-world environmental awareness.

---

## NASA Space Apps Context

This project was built under the **GLOBE Protocol Games** challenge.

The objective was to create an interactive solution that helps users understand environmental issues such as pollution, deforestation, and climate impact through engaging gameplay.
...
Each stage introduces unique challenges and questions.
...
```
.
├── environmental_boss_fight_game.py
├── assets/
│   ├── images/
│   ├── sounds/
│   │   └── music.mp3
